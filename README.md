...
##Usage
Access the Text X1 App : https://023ashutosh.github.io/text_x1/ 
Enter or paste the text you want to format.
Choose the desired formatting option: uppercase, lowercase, or clear copy.
The formatted text will be displayed, and you can copy it to the clipboard.
